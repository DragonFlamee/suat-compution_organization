...
//output to lsu 
assign lsu_op = {inst_lb,inst_sb,inst_lw,inst_sw};

//output to wb signal TODO
assign wbctl_op = {type_load, rd_wen & (~type_load)};
...
assign alu_ctl[3] = inst_add | inst_addi | inst_sub | inst_lui | inst_auipc | jump | type_load | type_store;
...
assign data1 =
	({32{type_r | type_i | type_branch | type_load | type_store}} & rs1_data) |
	({32{inst_auipc}} & pc) |
	({32{inst_lui}} & 32'b0) |
	({32{jump}} & snpc);
...
assign data2 =
	...
	({32{type_i | inst_lui | inst_auipc | type_load | type_store}} & imm) |
	({32{jump}} & 32'b0);

assign data3 =
	({32{inst_jal | type_branch}} & pc) |
	({32{type_store}} & rs2_data) |
